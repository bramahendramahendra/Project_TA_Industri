                ...
                <div class="sparkline8-list shadow-reset">
                    ...
                    <div class="sparkline8-graph">
                        <div class="datatable-dashv1-list custom-datatable-overright">
                            <div id="toolbar">
                                <button type="button" data-toggle="modal" data-target="#Create-Keuangan" class="btn btn-custon-rounded-three btn-success">Input User Bagian Keuangan</button>
                            </div>
                            <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                ...
                                <tbody>
                                <?php $no=0; 
                                foreach ($data_keuangan as $value) { ?>
                                    <tr>
                                        <td><?= ++$no; ?></td>
...
<div id="Create-Keuangan" class="modal modal-adminpro-general fullwidth-popup-InformationproModal PrimaryModal-bgcolor fade" role="dialog">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="all-form-element-inner">
                                    <form action="<?= site_url() ?>Admin/Keuangan/Create_Keuangan" method="post">
...
<?php foreach ($data_keuangan as $value) {?>
<div id="Detail-Agen<?php echo  $value['id'] ?>" class="modal modal-adminpro-general default-popup-PrimaryModal PrimaryModal-bgcolor fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="#" data-dismiss="modal" data-toggle="modal" data-target="#Edit-Keuangan<?php echo  $value['id'] ?>">Edit</a>
                <a href="<?= site_url() ?>Admin/Keuangan/Delete_Keuangan/<?= $value['id']; ?>">Delete</a>
            </div>
        </div>
    </div>
</div>
...
<?php foreach ($data_keuangan as $value) {?>
<div id="Edit-Keuangan<?php echo  $value['id'] ?>" class="modal modal-adminpro-general fullwidth-popup-InformationproModal PrimaryModal-bgcolor fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-close-area modal-close-df">
                <a class="close" data-dismiss="modal" href="#"><i class="fa fa-close"></i></a>
                ...
                <div class="sparkline12-graph">
                    <div class="basic-login-form-ad">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="all-form-element-inner">
                                    <form action="<?= site_url() ?>Admin/Keuangan/Update_Keuangan/<?php echo  $value['id'] ?>" method="post">
...
<div id="Delete-Keuangan" class="modal modal-adminpro-general FullColor-popup-DangerModal PrimaryModal-bgcolor fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-close-area modal-close-df">
                <a class="close" data-dismiss="modal" href="#"><i class="fa fa-close"></i></a>
