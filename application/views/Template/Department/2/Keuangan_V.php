    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar">
            <div class="sidebar-header">
                ...
                <h3><?= $data_user_keuangan->username; ?></h3>
                <p><?= $status; ?></p>
            ...
            <div class="left-custom-menu-adp-wrap">
                <ul class="nav navbar-nav left-sidebar-menu-pro">
                    <li class="nav-item">
                        <a href="<?= site_url()?>Keuangan/Dashboard" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                    ...
                    <li class="nav-item">
                        <a href="<?= site_url()?>Keuangan/Pesanan" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                ...
                                <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                            ...
                                            <span class="admin-name"><?= $data_user_keuangan->username; ?></span>
                                        ...
                                        <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated flipInX">
                                            ...
                                            <li><a href="<?= site_url() ?>Keuangan/Logout"><span class="adminpro-icon adminpro-locked author-log-ic"></span>Log Out</a>
                                            </li>
                                        </ul>
                                    </li>
